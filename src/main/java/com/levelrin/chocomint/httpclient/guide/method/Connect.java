...
/**
 * It represents HTTP CONNECT method.
...
public final class Connect {
    ...
    /**
     * Constructor.
     * @param config See {@link Connect#config}.
     */
    public Connect(final Map<ConfigKeys, Object> config) {
        this.config = config;
    }
     ...
     * @return This object.
     */
    public Connect header(final String name, final String value) {
