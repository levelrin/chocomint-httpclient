...
/**
 * It represents HTTP PATCH method.
...
public final class Patch {
    ...
    /**
     * Constructor.
     * @param config See {@link Patch#config}.
     */
    public Patch(final Map<ConfigKeys, Object> config) {
        this.config = config;
    }
     ...
     * @return This object.
     */
    public Patch header(final String name, final String value) {
