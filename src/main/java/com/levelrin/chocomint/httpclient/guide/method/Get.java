...
public final class Get {
    ...
    /**
     * Constructor.
     * @param config See {@link Get#config}.
     */
    public Get(final Map<ConfigKeys, Object> config) {
        this.config = config;
    }
     ...
     * @return This object.
     */
    public Get header(final String name, final String value) {
