...
/**
 * It represents HTTP OPTIONS method.
...
public final class Options {
    ...
    /**
     * Constructor.
     * @param config See {@link Options#config}.
     */
    public Options(final Map<ConfigKeys, Object> config) {
        this.config = config;
    }
     ...
     * @return This object.
     */
    public Options header(final String name, final String value) {
