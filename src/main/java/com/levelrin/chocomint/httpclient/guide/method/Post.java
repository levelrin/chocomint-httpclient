...
/**
 * It represents HTTP POST method.
...
public final class Post {
    ...
    /**
     * Constructor.
     * @param config See {@link Post#config}.
     */
    public Post(final Map<ConfigKeys, Object> config) {
        this.config = config;
    }
     ...
     * @return This object.
     */
    public Post header(final String name, final String value) {
