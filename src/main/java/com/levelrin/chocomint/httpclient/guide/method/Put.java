...
public final class Put {
    ...
    /**
     * Constructor.
     * @param config See {@link Put#config}.
     */
    public Put(final Map<ConfigKeys, Object> config) {
        this.config = config;
    }
     ...
     * @return This object.
     */
    public Put header(final String name, final String value) {
