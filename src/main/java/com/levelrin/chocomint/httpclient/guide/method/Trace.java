...
/**
 * It represents HTTP TRACE method.
...
public final class Trace {
    ...
    /**
     * Constructor.
     * @param config See {@link Trace#config}.
     */
    public Trace(final Map<ConfigKeys, Object> config) {
        this.config = config;
    }
     ...
     * @return This object.
     */
    public Trace header(final String name, final String value) {
